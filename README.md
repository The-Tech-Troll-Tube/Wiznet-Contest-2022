...
- TO RESET THE BOARD NUKE IT with the flash_nuke.uf2 file from [here](/flash_nuke.uf2), to flash drop the file on to the board after pressing the button and connecting to usb.
...
- Create the a dashboard in Adafruit IO as shown in the Image. ![Adafruit-dash-sample](/assets/Adafruit-dash-sample)
